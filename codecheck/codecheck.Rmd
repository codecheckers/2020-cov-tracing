...
`outputs-orig` and the R script edited to create a new outputs folder.
...
```{bash, eval=FALSE}
time Rscript scripts/contact_model.R
```
This took 7m 10s to complete on a Thinkpad laptop.
